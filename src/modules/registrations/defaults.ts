...
export const DEFAULT_REGISTRATION_FIELDS: FormFieldDef[] = [
  ...
  { key: "attendanceDates", label: "Attendance dates", type: "multiselect", required: false, sortOrder: 9 },
  { key: "dietary", label: "Dietary requirements", type: "textarea", required: false, sortOrder: 10 },
  { key: "accessibility", label: "Accessibility requirements", type: "iconpicker", required: false, sortOrder: 11 },
