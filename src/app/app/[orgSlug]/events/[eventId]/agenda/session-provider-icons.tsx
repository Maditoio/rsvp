  ...
  if (muted) {
    return (
      <svg
        ...
        className={cn("shrink-0", className)}
      >
        <rect width="24" height="24" rx="4" fill="currentColor" className="text-slate-300" />
        <path
          fill="currentColor"
          className="text-slate-400"
...
export function SessionProviderIcons({
  ...
  const iconButtonClass =
    "rounded-lg p-1 transition-colors hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-indigo-600";
