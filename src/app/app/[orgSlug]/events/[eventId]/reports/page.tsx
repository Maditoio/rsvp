  ...
  return (
    <div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <h2 className="font-medium text-slate-900">Invitees</h2>
          <p className="mt-1 text-sm text-slate-600">
            Contacts for this event with their latest invitation status.
          </p>
          <a
            href={`${base}?kind=invitees`}
            className="mt-4 inline-flex rounded-full bg-primary-600 px-4 py-2 text-sm text-white"
          >
            Download invitees CSV
          </a>
        </Card>
        <Card>
          <h2 className="font-medium text-slate-900">Attendees</h2>
          <p className="mt-1 text-sm text-slate-600">
